...
const AdminBlogHome = ({ adminData }) => {
  ...
  const update = (pid) => {
    // console.log(pid)
    axios
      .put("http://localhost:5000/blogupdate/" + pid, fd)
      .then(
  ...
  const deleteBlog = (pid) => {
    // console.log(pid)
    axios
      .delete("http://localhost:5000/blogdelete/" + pid)
      .then((window.location = "/admin-blog-home"))
      .catch();
  };
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-10 col-12">
                    <Link to="/admin-blog-post" className="btn btn-info">
                      Add Blog
                    </Link>
                    <h3 className="m-5">There is no any blogs added!!!</h3>
                  </div>
                </div>
              </div>
            ) : (

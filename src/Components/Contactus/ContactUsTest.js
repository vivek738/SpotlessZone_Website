          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              <div class="row mb-3">
                ...
                <div class="col">
                  <input type="text" class="form-control" placeholder="Full Name" aria-label="First Name" value={fname} onChange={(e) => setFname(e.target.value)} id="fname"/>
                </div>
                <div class="col">
                  <input type="text" class="form-control" placeholder="Your Email" aria-label="Your Email" value={email} onChange={(e) => setEmail(e.target.value)} id="email"/>
                </div>
              ...
              <div class="row mb-3">
                <div class="col">
                  <input type="text" className="form-control mb-3" placeholder="Phone no" aria-label="Phone no" value={phone} onChange={(e) => setPhone(e.target.value)} id="phone"/>
                </div>

                <div class="col">
                  <input type="text" className="form-control mb-3" placeholder="Service Name" aria-label="serviceName" value={serviceName} onChange={(e) => setServiceName(e.target.value)} id="serviceName"/>
                </div>
              ...
              <div className="mb-3">
                <textarea name="" id="description" cols="30" rows="4" className="form-control" value={description} onChange={(e) => setDesc(e.target.value)} ></textarea>
              </div>

              <button className="btn btn-primary" onClick={submitContact}  id="submitBtn">SEND A MESSAGE</button>

                            ...
                            <div className="row">
                                <div className="col-md-6 mb-4">
                                    <div className="px-0 py-2 bg-white shadow rounded">
                                        ...
                                        <img className='bimg' src={First} alt="" />
                                        </div>
                                        <div className="mx-4 my-3">
                                            <p className="text text-secondary fs-3 fw-bold">The Secret of your kitchen cleaning</p>
                                            ...
                                            <p className="text text-secondary">
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus est explicabo non expedita, culpa tenetur tempora dolorem temporibus quaerat
                                            </p>
                                            <Link to="/blogs/blog-details" className='text-decoration-none'>
                                                <div className="d-flex justify-content-start align-items-center">

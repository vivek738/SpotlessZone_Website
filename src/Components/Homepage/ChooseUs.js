        ...
        <div className="container col-md-10">
          ...
          <div className="text-center">
            <p className="text-muted fs-6">
              ...
              Similique porro enim tempora reprehenderit. Fugiat amet
              consequuntur est possimus ab fugit. Minus magni ad voluptate rerum
              ex dolores aperiam harum aliquam!
            </p>
          </div>
          <div className="text-justify">
            <div className="d-flex justify-content-center py-5">
              <div className="">
                <div className="mb-4">
                  <i
                    className="fa fa-diamond fs-1 d-flex justify-content-end mb-2"
                    style={{ color: "teal" }}
                  ></i>
                ...
                <div className="mb-4">
                  <i
                    className="fa fa-umbrella fs-1 d-flex justify-content-end mb-2"
                    style={{ color: "teal" }}
                  ></i>
                  <p className="h1 fs-3 mb-4 d-flex justify-content-end ">
                    INSURED AND BONDED
              ...
              <div>
                <div className="mb-4">
                  <i
                    className="fa fa-home fs-1 d-flex justify-content-start mb-2"
                    style={{ color: "teal" }}
                  ></i>
                ...
                <div className="mb-4">
                  <i
                    className="fa fa-user-secret fs-1 d-flex justify-content-start mb-2"
                    style={{ color: "teal" }}
                  ></i>
                  <p className="h1 fs-3 mb-4 d-flex justify-content-start ">
                    RELIABLE CREWS
